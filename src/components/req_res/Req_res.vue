...
<script>
  ...
  export default {
    name: "Req_res",
    components: {Divider, Icon, XHeader},
    data() {
      return {
        res_qua: [],
        tit: '全部小区信息'
...
<style scoped>
  ...
  @media screen and (min-device-width: 100px) and (max-device-width: 250px) {
    html {
      font-size: 6px;
    }
  ...
  @media screen and (min-device-width: 250px)and (max-device-width: 320px) {
    html {
      font-size: 8px;
    }
